...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-200 p-4">
        <div class="lg:w-2/4 mx-auto py-8 px-6 bg-white rounded-xl">
            <h1 class="font-bold text-5xl text-center mb-8">To Do List Website</h1>
            ...
            <div class="mb-6">
                <form action="/" class="flex flex-col space-y-4" method="POST">
                    ...
                    <textarea name="description" placeholder="To Do List Description" class="py-3 px-4 bg-gray-100 rounded-xl"></textarea>
